...
def generate_sample_property_data(num_properties=500, output_path='sample_properties.csv'):
    """Generate sample property data for ML model training."""
    ...
    print(f"Generated {num_properties} sample properties and saved to {output_path}")
...
if __name__ == "__main__":
    ...
    output_path = os.path.join(output_dir, 'sample_properties.csv')
    generate_sample_property_data(1000, output_path)